::==  This moves files and logs the move.
...
echo =================================
echo Move files using robocopy
...
::== SAMPLE
REM robocopy C:\ToArchive\Backups\FY2011 E:\Backups\FY2011 /E /ZB /MOVE /R:20 /W:60 /FP /NP /LOG+:C:\TechTools\Logs\temp_move_files-!vDate!.log
